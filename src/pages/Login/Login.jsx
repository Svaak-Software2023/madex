                                ...
                                <form className="form" onSubmit={handleSubmit(submithandler)}>
                                    <div className="mb-3">
                                        ...
                                        <input
                                            id='text'
                                            type="text"
                                            className={`form-control  ${errors.emailAndUserName ? "is-invalid" : ""}`}
                                            name='emailAndUserName'
                                            {...register("emailAndUserName", { required: true })}
                                        />
                                        {errors.emailAndUserName && (
                                            <div className="invalid-feedback mt-1">Username or Email is required</div>
                                        )}
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        />
                                        {errors.password && (
                                            <div className="invalid-feedback mt-1">Password is required</div>
                                        )}
                                    ...
                                    {auth.error && auth.error.message && <p className='text-danger fw-bold text-center'>{auth.error.message}</p>}

                                    {/* showing Success mesage  */}
                                    {auth.user && <p className='text-success fw-bold text-center'>{auth.message}</p>}
