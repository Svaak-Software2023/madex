...
function Upload() {
  ...
  //Import useDispatch to triger reducer functions
  ...
  const submitHandler = (data) => {
    ...
    dispatch(videoUpload({formData,setPercentage,navigate}))
  }
          ...
          <div className="col-lg-6 col-12 my-3">
            <div className="upload-video-input" onClick={selectVideoHandler}>
              <div className='upload-vido-input-inner'>
                ...
                {!file && !file.videoFile && <p className='text-danger fw-bold text-center'>Video is required</p>}
              ...
              <div className="row">
                <div className="col-lg-12 col-12">
                  <div className="video-upload-form-input">
                    ...
                    />
                    {errors.videoTitle && <p className='text-danger'>Video Title is required</p>}
                  </div>
                </div>
                <div className="col-lg-12 col-12">
                  <div className="video-upload-form-input">
                    ...
                    />
                    {errors.videoDescription && <p className='text-danger'>Video Description is required</p>}
                  </div>
                </div>
                <div className="col-lg-12 col-12">
                  <div className="video-upload-form-input">
                    ...
                    >
                      ...
                      {
                        category.categoryData && category?.categoryData?.map((item) =>
                          <option key={item._id} value={item._id}>{item.categoryName}</option>
                        )
                      }
                    </select>
                    {errors.videoCategories && <p className='text-danger'>Video Categories is required</p>}
                  </div>
                </div>
                ...
                <div className="col-lg-12 col-12">
                  <div className="video-upload-form-input">
                    ...
                    <input type="file"
                      ...
                      onChange={fileHandler}
                    />
                    {errors.videoThumbnails && <p className='text-danger'>Video Thumbnails is required</p>}
                  </div>
                </div>
