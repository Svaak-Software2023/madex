...
const SingleVideo = () => {
  ...
  if(!video.singleVideo) return<h4 className='text-center mt-5'>Sorry, the video data could not be found</h4>;

  // const [recommendData,setRecommendData]=useState()
  const recommendData=video.videoData&&video.videoData.filter((item)=>item._id!==video.singleVideo._id)
  return (
    <>
      <div className="">
