...
import { MdOutlineHelpOutline, MdOutlineSettings, MdOutlineSettingsBrightness } from "react-icons/md";
...
function Header({ toggle }) {
  ...
  useEffect(() => { setDropdown(false) }, [pathname])
    ...
    <>
      <div className="header-main">
        ...
        <div className="menu-bar">
          ...
          <Link to="/">
            <div className="logo">
              <img src="/assets/logo.png" alt="Logo" width={100} height={50} layout="responsive" />
            </div>
          </Link>
        </div>
          ...
          {dropdown &&
            <div className="login-user-details">
              <h3 className='dropdown-back'>
                <IoMdArrowRoundBack onClick={() => setDropdown(!dropdown)} /> <span>Accounts</span>
              </h3>
              ...
              <ul className="mt-3 dropdown-menu-list">
               ...
               { channel.data?<div className="view-chanel-option">
               <Link to="/your-channel" className='text-primary'>View your station</Link>
               </div>
               :<div className="view-chanel-option" onClick={openModal}>Create your station</div>
}
                <li>
                  <div className="dropdown-option" onClick={logout}>
                    <PiSignOutBold /><p>Sign out</p>
                  </div>
                </li>
                <li>
