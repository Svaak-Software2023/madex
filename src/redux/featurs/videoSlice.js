...
export const getSingleVideo = createAsyncThunk("video/getSingle", async (videoId) => {
    try {
...
export const videoUpload = createAsyncThunk("video/upload", async ({formData,setPercentage,navigate}) => {
    try {
...
export const getAllCategoryVideo = createAsyncThunk("category/video",async (categoryId)=>{
    try {
